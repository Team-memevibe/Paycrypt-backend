...
export async function POST(req) {
    try {
        ...
        if (!requestId || !billersCode || !serviceID || !variation_code || !amount || !phone || !cryptoUsed || !cryptoSymbol || !transactionHash || !userAddress || !chainId || !chainName) {
        ...
        const response = errorHandler(error, 'TV API Route');
